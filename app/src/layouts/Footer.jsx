...
const Footer = () => {
  return (
    <footer className="bg-green-600/70 backdrop-blur">
    <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="grid gap-8 lg:col-span-2 grid-cols-2 lg:grid-cols-4 md:place-content-evenly place-content-center">
          <div>
            <p className="font-medium text-white">
              Company
            </p>
            <nav className="flex flex-col mt-4 space-y-2 text-sm text-white/60">
